...
var instance_access = axios.create({
    baseURL: 'http://47.105.120.203:30080/api/v1',
    timeout: 10000,
  });
...
module.exports = {  
    ...
    getAllDeviceAttr: async (deviceId,access_token) => {     //获取设备所有属性信息
        try{
            ...
            var res = await request.get('http://47.105.120.203:30080/api/v1/deviceaccess/allattributes/'+deviceId)
    ...
    sendControl: async (deviceId,body,access_token)=>{
        ...
        try{
            ...
            var res = await request.post('http://47.105.120.203:30080/api/v1/deviceaccess/rpc/'+deviceId+'/'+requestId)
